...
const Nav = () => {
    ...
    return (
    <nav className='bg-slate-900 text-white flex flex-row justify-between items-center p-4 static top-0 left-0 right-0 z-10 shadow'>
        ...
        <div className='hidden md:block'><UnderlineLink><a href="/">Home</a></UnderlineLink></div>
        <h1 className='text-3xl'>Playconomics</h1>
        <ul className='flex flex-row-reverse gap-8 whitespace-nowrap'>
